...
namespace TyphoonRollers
{
    ...
    /// </summary>
    class NotRotationParticleSystem : ParticleSystem
    {
        public NotRotationParticleSystem(Game1 game, ContentManager content)
            : base(game, content)
        { }
        ...
        {
            settings.TextureName = "ParticleTexture/NotRotationParticle";
