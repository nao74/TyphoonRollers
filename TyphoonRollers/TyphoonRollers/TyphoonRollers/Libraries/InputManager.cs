...
namespace TyphoonRollers
{
    ...
    public class InputManager
    {
        ...
        public static bool AnyButtonDown(PlayerIndex player)
        {
            bool pressed = false;
            int index = (int)player;
            ...
            // 押されていればtrueとする
            if (currentPadState[index].IsButtonDown(Buttons.A))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.B))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.Back))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.BigButton))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.DPadDown))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.DPadLeft))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.DPadRight))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.DPadUp))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.LeftShoulder))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.LeftTrigger))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.RightShoulder))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.RightTrigger))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.Start))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.X))
                pressed = true;
            if (currentPadState[index].IsButtonDown(Buttons.Y))
                pressed = true;
